...
#************************lbls and entries************************
         ...
         lbl_cust_contact=Label(labelframeleft,text="1 BHK Flat for Rent",font=("arial",12,"bold"),padx=2,pady=4)
         ...
         lbl_cust_contact=Label(labelframeleft,text="2. Free rental agreement",font=("arial",12),padx=2,pady=2)
         lbl_cust_contact.grid(row=13,column=0,sticky=W)  

         lbl_cust_contact=Label(labelframeleft,text="3. Free poliice verifiication",font=("arial",12),padx=2,pady=2)
         lbl_cust_contact.grid(row=14,column=0,sticky=W)
           
#*******************************Rightside img****************************************
         img3=Image.open(r"C:\Users\hp\OneDrive\Desktop\managementsystem\MSImages\11.jpg")
